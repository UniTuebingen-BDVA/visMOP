...
def relayout(graph, init_pos):
    ...
    pos = forceatlas2.forceatlas2_networkx_layout(
        graph, pos=init_pos, iterations=15)
    return pos
...
def get_spring_layout_pos(node_dict, init_scale=20000):
    ...
    print("Graph has {} Nodes and {} Edges (Bidirectional Edges counted once)".format(
    ...
    pos_out = {k: ((v[0] - min_x)/divisor_x, (v[1] - min_y)/divisor_y)

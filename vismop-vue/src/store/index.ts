...
export default new Vuex.Store({
  ...
  actions: {
    ...
    setFCS ({ commit }, val) {
      ...
      const colorScaleTranscriptomics = d3.scaleSequential(d3.interpolateRdBu).domain([quantTranscriptomics[0], quantTranscriptomics[1]])
      const colorScaleProteomics = d3.scaleSequential(d3.interpolateRdBu).domain([quantTranscriptomics[0], quantTranscriptomics[1]])
